          ...
          <div className="card p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={f.key} className={f.key === "department" ? "md:col-span-2" : ""}>
          ...
          <div className="card p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              {[
                ...
                { label: "Max Consultations Per Day", key: "maxPerDay", type: "number" },
                { label: "Default Duration (min)", key: "defaultDuration", type: "number" },
              ].map(f => (
                <div key={f.key}>
                  <label className="text-xs text-slate-500 font-medium mb-1 block">{f.label}</label>
                  <input
            ...
            <div className="space-y-3">
              {[
                { label: "Email Notifications", sub: "Receive email alerts for new consultation requests", key: "notifyEmail" },
                { label: "System Notifications", sub: "Show in-app notifications", key: "notifySystem" },
                { label: "Auto-Waitlist When Full", sub: "Automatically waitlist requests when no slots are available", key: "autoWaitlist" },
              ].map(t => (
                <div key={t.key} className="flex items-center justify-between py-2" style={{ borderTop: "1px solid #f8fafc" }}>
                  ...
                  <button
                    ...
                    style={{ background: form[t.key as keyof typeof form] ? "#1d4ed8" : "#e2e8f0" }}
                  >
